    ...
    <Container>
        <Row>
            <div className='nav__wrapper'>
              ...
              <i class="ri-pantone-line"></i> Educare
            </h2>
                </div>
            ...
            <div className='nav__icons'>
                ...
                <div className='profile'> 
                    ...
                    onClick={toggleProfileActions}>
                        { currentUser? <div className='d-flex align-items-center justify-content-center flex-column'><span onClick={logout}>Logout</span>
